...
├── content.config.ts     # Astro Content Collections config (blog)
...
│   ├── blog/index.astro       # Blog list page (static, from content collection)
│   ├── blog/[slug].astro     # Blog post page (static, prose typography)
│   ├── admin/index.astro     # Full admin dashboard (SSR, secret-protected)
│   ├── about.astro           # Static
│   ├── 404.astro             # Static
│   ├── sitemap.xml.ts        # Static (from build data + blog collection)
