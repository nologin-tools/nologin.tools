...
│   └── {zh,ja,ko,es,fr,de,pt}.json  # Translated UI strings (English en.json is source of truth)
├── data/
...
│   └── translations/{locale}.json  # Tool description translations (synced via scripts/sync-tool-translations.mjs)
...
│   └── {zh,ja,...}/      # Translated blog posts (curated)
