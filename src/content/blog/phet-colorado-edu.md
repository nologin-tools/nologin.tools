---
title: "PhET Simulations: 150+ Interactive Science Labs in Your Browser, No Signup"
description: "PhET Interactive Simulations from University of Colorado Boulder brings hands-on STEM experiments to any browser — completely free, no account needed."
...
> "When students interact with a simulation, they construct their own mental models rather than receiving someone else's. That active construction is what makes understanding stick."
> — Based on [PhET's research publications](https://phet.colorado.edu/en/research)
...
You visit [phet.colorado.edu](https://phet.colorado.edu), browse by subject or grade level, click any simulation, and it loads. No modal asking for your email. No "sign up for free to continue." No tracking wall.
...
PhET's code lives on GitHub under the [phetsims organization](https://github.com/phetsims). Each simulation is its own repository, written in JavaScript/TypeScript using a custom framework called Scenery for rendering. The core infrastructure is MIT licensed.
...
| Tool | Subject Focus | Interactivity Level | Account Required |
|------|--------------|---------------------|-----------------|
| [PhET](https://phet.colorado.edu) | Science + Math (broad) | High — full lab controls | No |
| [Desmos](/tool/desmos-com-calculator) | Math (graphing) | High — function-based | No |
| [GeoGebra](/tool/geogebra-org-calculator) | Math + Geometry | High — dynamic geometry | No |
| [VisuAlgo](/tool/visualgo-net) | CS Algorithms | Medium — step-through visualization | No |
| [Python Tutor](/tool/pythontutor-com) | Programming | Medium — code execution trace | No |
